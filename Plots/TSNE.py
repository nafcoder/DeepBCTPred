...
scatter = plt.scatter(tsne_results[:, 0], tsne_results[:, 1], c=labels, cmap='viridis', alpha=0.7, s=30, edgecolors='k')
...
plt.title("t-SNE visualization of the last hidden layer features", pad=20)
plt.xlabel("Comp 1")
plt.ylabel("Comp 2")
plt.tight_layout()
plt.show()