...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.block = timm.create_model('convnext_base', pretrained=True)
        self.block.head.fc = nn.Linear(self.block.num_features, 1000)
...
best_epoch = 0
best_metric = 0
with open('Results/convnext_base_pretrained.csv', 'w') as f:
